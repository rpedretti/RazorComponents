    ...
    public partial class BingMapPushpin : BaseBingMapEntity
    {
        ...
        public event EventHandler<MouseEventArgs<BingMapPushpin>> OnClick
        {
            add
            {
                ...
                if (_onClick == null)
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PushpinEvents.Click, thisRef, nameof(EmitPushpinEvent));
                }
                _onClick += value;
            }
            remove
            {
                ...
                if (_onClick == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PushpinEvents.Click);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPushpin>> OnDoubleClick
        {
            add
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PushpinEvents.DoubleClick, thisRef, nameof(EmitPushpinEvent));
                }
            ...
            remove
            {
                ...
                if (_onDoubleClick == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PushpinEvents.DoubleClick);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPushpin>> OnDrag
        {
            add
            {
                ...
                if (_onDrag == null)
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PushpinEvents.Drag, thisRef, nameof(EmitPushpinEvent));
                }
                _onDrag += value;
            }
            remove
            {
                ...
                if (_onDrag == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PushpinEvents.Drag);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPushpin>> OnDragEnd
        {
            add
            {
                ...
                if (_onDragEnd == null)
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PushpinEvents.DragEnd, thisRef, nameof(EmitPushpinEvent));
                }
                _onDragEnd += value;
            }
            remove
            {
                ...
                if (_onDragEnd == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PushpinEvents.DragEnd);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPushpin>> OnDragStart
        {
            add
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PushpinEvents.DragStart, thisRef, nameof(EmitPushpinEvent));
                }
                _onDragStart += value;
            }
            remove
            {
                ...
                if (_onDragStart == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PushpinEvents.DragStart);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPushpin>> OnMouseDown
        {
            add
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PushpinEvents.MouseDown, thisRef, nameof(EmitPushpinEvent));
                }
                _onMouseDown += value;
            }
            remove
            {
                ...
                if (_onMouseDown == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PushpinEvents.MouseDown);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPushpin>> OnMouseOut
        {
            add
            {
                ...
                if (_onMouseOut == null)
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PushpinEvents.MouseOut, thisRef, nameof(EmitPushpinEvent));
                }
                _onMouseOut += value;
            }
            remove
            {
                ...
                if (_onMouseOut == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PushpinEvents.MouseOut);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPushpin>> OnMouseOver
        {
            add
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PushpinEvents.MouseOver, thisRef, nameof(EmitPushpinEvent));
                }
                _onMouseOver += value;
            }
            remove
            {
                ...
                if (_onMouseOver == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PushpinEvents.MouseOver);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPushpin>> OnMouseUp
        {
            add
            {
                ...
                if (_onMouseUp == null)
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PushpinEvents.MouseUp, thisRef, nameof(EmitPushpinEvent));
                }
                _onMouseUp += value;
            }
            remove
            {
                ...
                if (_onMouseUp == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PushpinEvents.MouseUp);
                }
                CheckThisRef();
            }
        }
