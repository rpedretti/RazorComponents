    ...
    public partial class BingMapPolygon : BaseBingMapEntity
    {
        ...
        public event EventHandler<MouseEventArgs<BingMapPolygon>> OnClick
        {
            add
            {
                ...
                if (_onClick == null)
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PolygonEvents.Click, thisRef, nameof(EmitPolygonEvent));
                }
                _onClick += value;
            }
            remove
            {
                ...
                if (_onClick == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PolygonEvents.Click);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPolygon>> OnDoubleClick
        {
            add
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PolygonEvents.DoubleClick, thisRef, nameof(EmitPolygonEvent));
                }
            ...
            remove
            {
                ...
                if (_onDoubleClick == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PolygonEvents.DoubleClick);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPolygon>> OnMouseDown
        {
            add
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PolygonEvents.MouseDown, thisRef, nameof(EmitPolygonEvent));
                }
                _onMouseDown += value;
            }
            remove
            {
                ...
                if (_onMouseDown == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PolygonEvents.MouseDown);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPolygon>> OnMouseOut
        {
            add
            {
                ...
                if (_onMouseOut == null)
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PolygonEvents.MouseOut, thisRef, nameof(EmitPolygonEvent));
                }
                _onMouseOut += value;
            }
            remove
            {
                ...
                if (_onMouseOut == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PolygonEvents.MouseOut);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPolygon>> OnMouseOver
        {
            add
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PolygonEvents.MouseOver, thisRef, nameof(EmitPolygonEvent));
                }
                _onMouseOver += value;
            }
            remove
            {
                ...
                if (_onMouseOver == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PolygonEvents.MouseOver);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPolygon>> OnMouseUp
        {
            add
            {
                ...
                if (_onMouseUp == null)
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PolygonEvents.MouseUp, thisRef, nameof(EmitPolygonEvent));
                }
                _onMouseUp += value;
            }
            remove
            {
                ...
                if (_onMouseUp == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PolygonEvents.MouseUp);
                }
                CheckThisRef();
            }
        }
