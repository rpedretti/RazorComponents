    ...
    public partial class BingMapPolyline : BaseBingMapEntity
    {
        ...
        public event EventHandler<MouseEventArgs<BingMapPolyline>> OnClick
        {
            add
            {
                ...
                if (_onClick == null)
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PolylineEvents.Click, thisRef, nameof(EmitPolylineEvent));
                }
                _onClick += value;
            }
            remove
            {
                ...
                if (_onClick == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PolylineEvents.Click);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPolyline>> OnDoubleClick
        {
            add
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PolylineEvents.DoubleClick, thisRef, nameof(EmitPolylineEvent));
                }
            ...
            remove
            {
                ...
                if (_onDoubleClick == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PolylineEvents.DoubleClick);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPolyline>> OnMouseDown
        {
            add
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PolylineEvents.MouseDown, thisRef, nameof(EmitPolylineEvent));
                }
                _onMouseDown += value;
            }
            remove
            {
                ...
                if (_onMouseDown == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PolylineEvents.MouseDown);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPolyline>> OnMouseOut
        {
            add
            {
                ...
                if (_onMouseOut == null)
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PolylineEvents.MouseOut, thisRef, nameof(EmitPolylineEvent));
                }
                _onMouseOut += value;
            }
            remove
            {
                ...
                if (_onMouseOut == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PolylineEvents.MouseOut);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPolyline>> OnMouseOver
        {
            add
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PolylineEvents.MouseOver, thisRef, nameof(EmitPolylineEvent));
                }
                _onMouseOver += value;
            }
            remove
            {
                ...
                if (_onMouseOver == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PolylineEvents.MouseOver);
                }
                CheckThisRef();
            }
        }
        ...
        public event EventHandler<MouseEventArgs<BingMapPolyline>> OnMouseUp
        {
            add
            {
                ...
                if (_onMouseUp == null)
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, PolylineEvents.MouseUp, thisRef, nameof(EmitPolylineEvent));
                }
                _onMouseUp += value;
            }
            remove
            {
                ...
                if (_onMouseUp == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, PolylineEvents.MouseUp);
                }
                CheckThisRef();
            }
        }
