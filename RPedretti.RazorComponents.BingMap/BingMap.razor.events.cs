...
namespace RPedretti.RazorComponents.BingMap
{
    public partial class BingMapBase : ComponentBase
    {
        ...
        [Parameter]
        public Func<MouseEventArgs<BingMapBase>, Task> Click
        {
            get => _click;
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, BingMapEvents.Click, nameof(EmitMapEvent));
                }
                else if (_click != null && value == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, BingMapEvents.Click);
                }
        ...
        [Parameter]
        public Func<MouseEventArgs<BingMapBase>, Task> DoubleClick
        {
            get => _doubleClick;
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, BingMapEvents.DoubleClick, nameof(EmitMapEvent));
                }
                else if (_doubleClick != null && value == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, BingMapEvents.DoubleClick);
                }
        ...
        [Parameter]
        public Func<MouseEventArgs<BingMapBase>, Task> RightClick
        {
            get => _rightClick;
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, BingMapEvents.RightClick, nameof(EmitMapEvent));
                }
                else if (_rightClick != null && value == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, BingMapEvents.RightClick);
                }
        ...
        [Parameter]
        public Func<MouseEventArgs<BingMapBase>, Task> MouseMove
        {
            get => _mouseMove;
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, BingMapEvents.MouseMove, nameof(EmitMapEvent));
                }
                else if (_mouseMove != null && value == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, BingMapEvents.MouseMove);
                }
        ...
        [Parameter]
        public Func<MouseEventArgs<BingMapBase>, Task> MouseWheel
        {
            get => _mouseWheel;
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, BingMapEvents.MouseWheel, nameof(EmitMapEvent));
                }
                else if (_mouseWheel != null && value == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, BingMapEvents.MouseWheel);
                }
        ...
        [Parameter]
        public Func<MouseEventArgs<BingMapBase>, Task> MouseDown
        {
            get => _mouseDown;
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, BingMapEvents.MouseDown, nameof(EmitMapEvent));
                }
                else if (_mouseDown != null && value == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, BingMapEvents.MouseDown);
                }
        ...
        [Parameter]
        public Func<MouseEventArgs<BingMapBase>, Task> MouseOut
        {
            get => _mouseOut;
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, BingMapEvents.MouseOut, nameof(EmitMapEvent));
                }
                else if (_mouseOut != null && value == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, BingMapEvents.MouseOut);
                }
        ...
        [Parameter]
        public Func<MouseEventArgs<BingMapBase>, Task> MouseOver
        {
            get => _mouseOver;
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, BingMapEvents.MouseOver, nameof(EmitMapEvent));
                }
                else if (_mouseOver != null && value == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, BingMapEvents.MouseOver);
                }
        ...
        [Parameter]
        public Func<MouseEventArgs<BingMapBase>, Task> MouseUp
        {
            get => _mouseUp;
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachEventFunctionName, Id, BingMapEvents.MouseUp, nameof(EmitMapEvent));
                }
                else if (_mouseUp != null && value == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, BingMapEvents.MouseUp);
                }
        ...
        public Func<Task> ViewChangeStart
        {
            ...
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachChangeEventFunctionName, Id, BingMapEvents.ViewChangeStart, nameof(EmitMapChangeEvent));
                }
                else if (_viewChangeStart != null && value == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, BingMapEvents.ViewChangeStart);
                }
        ...
        public Func<Task> ViewChangeEnd
        {
            ...
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachChangeEventFunctionName, Id, BingMapEvents.ViewChangeEnd, nameof(EmitMapChangeEvent));
                }
                else if (_viewChangeEnd != null && value == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, BingMapEvents.ViewChangeEnd);
                }
        ...
        public Func<Task> ViewChange
        {
            ...
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachChangeEventFunctionName, Id, BingMapEvents.ViewChange, nameof(EmitMapChangeEvent));
                }
                else if (_viewChange != null && value == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, BingMapEvents.ViewChange);
                }
        ...
        public Func<Task> MapTypeChanged
        {
            ...
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachChangeEventFunctionName, Id, BingMapEvents.MapTypeChanged, nameof(EmitMapChangeEvent));
                }
                else if (_mapTypeChanged != null && value == null)
                {
                    JSRuntime.InvokeAsync<object>(detachEventFunctionName, Id, BingMapEvents.MapTypeChanged);
                }
        ...
        public Func<Task> ThrottleViewChangeStart
        {
            ...
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachThrottleEventFunctionName, Id, BingMapEvents.ViewChangeStart, nameof(EmitMapChangeEvent));
                }
        ...
        public Func<Task> ThrottleViewChangeEnd
        {
            ...
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachThrottleEventFunctionName, Id, BingMapEvents.ViewChangeEnd, nameof(EmitMapChangeEvent));
                }
        ...
        public Func<Task> ThrottleViewChange
        {
            ...
            set
            {
                ...
                {
                    JSRuntime.InvokeAsync<object>(attachThrottleEventFunctionName, Id, BingMapEvents.ViewChange, nameof(EmitMapChangeEvent));
                }
